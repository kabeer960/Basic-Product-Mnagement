                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="row_table_{{$item->order_id}} text-center bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a role="button" class="approve_order bg-green-500 py-2 px-3 text-white" data-id="{{$item->order_id}}">Approve</a>
                                    <a role="button" class="cancel_order bg-red-500 py-2 px-3 text-white" data-id="{{$item->order_id}}">Cancel</a>
                                </td>
                            </tr>
                             @endforeach
                            </tbody>
