            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')">
                        <span class="dash_nav_set">{{ __('Home') }}</span>
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <span class="dash_nav_set">{{ __('Dashboard') }}</span>
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('manageproducts')" :active="request()->routeIs('manageproducts')">
                        <span class="dash_nav_set">{{ __('Manage Products') }}</span>
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('manageorders')" :active="request()->routeIs('manageorders')">
                        <span class="dash_nav_set">{{ __('Manage Orders') }}</span>
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('manageusers')" :active="request()->routeIs('manageusers')">
                        <span class="dash_nav_set">{{ __('Manage Users') }}</span>
                    </x-nav-link>
                </div>
                @endif
